...
def worker1(train_info):
    PatchGenerator(train_info, type='normal',
                   save_json_path='/home/liwenxi/panda/raw/PANDA/coco_json/train_s4.json')


def worker2(val_info):
    PatchGenerator(val_info, data_dir='/home/liwenxi/panda/raw/PANDA/image_test', type='sw', save_json_path='/home/liwenxi/panda/raw/PANDA/coco_json/test_trt.json')
